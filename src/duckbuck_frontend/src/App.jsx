    ...
    return (
        <div className='h-screen'>
            <div className='-mt-4 min-h-screen bg-[url(/duckbuck6.jpg)] bg-cover bg-center bg-no-repeat'>
                ...
                <div className='relative z-30 mx-auto mt-64 w-fit rounded-full border-2 border-purple-800 bg-ducky/80 p-4 px-32 py-6 shadow-lg'>
                    <img
                        src='/duckbuck2.jpg'
                        alt='logo'
                        width={512}
...
const Tokenomics = () => {
    return (
        <div className='flex items-start justify-center mt-52 gap-8'>
            <div className='flex flex-col'>
                <h1 className='font-ducky text-lg font-bold md:text-7xl'>
                    Tokenomics
                </h1>
